...
const file_echo_proto_rawDesc = "" +
	...
	"\x04Echo\x12<\n" +
	"\vEchoMessage\x12\x13.api.MessageRequest\x1a\x14.api.MessageResponse(\x010\x01B\bZ\x06./;apib\x06proto3"
...
var file_echo_proto_depIdxs = []int32{
	0, // 0: api.Echo.EchoMessage:input_type -> api.MessageRequest
	1, // 1: api.Echo.EchoMessage:output_type -> api.MessageResponse
