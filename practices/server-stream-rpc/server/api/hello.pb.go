...
const file_hello_proto_rawDesc = "" +
	...
	"\x02Hi\x125\n" +
	"\n" +
	"HelloWorld\x12\x11.api.HelloRequest\x1a\x12.api.HelloResponse0\x01B\bZ\x06./;apib\x06proto3"
...
var file_hello_proto_depIdxs = []int32{
	0, // 0: api.Hi.HelloWorld:input_type -> api.HelloRequest
	1, // 1: api.Hi.HelloWorld:output_type -> api.HelloResponse
